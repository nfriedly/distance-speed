 ...
 * @returns {{command: 'string', driver: string}|{command: string, driver: string, startHour: number, startMinute: number, endHour: number, endMinute: number, miles: number}}
 */
